...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
	...
	<!--//pop-up-box-->
	<!-- price range -->
	<link rel="stylesheet" type="text/css" href="assets/web/css/jquery-ui1.css">
	<!-- fonts -->
...
<body>
	...
	<script src="<?php echo base_url();?>assets/web/js/jquery.magnific-popup.js"></script>
	<script>
	...
	<!-- cart-js -->
	<script src="<?php echo base_url();?>assets/web/js/minicart.js"></script>
	<script>
	...
	<script src="<?php echo base_url();?>assets/web/js/move-top.js"></script>
	<script src="<?php echo base_url();?>assets/web/js/easing.js"></script>
	<script>
